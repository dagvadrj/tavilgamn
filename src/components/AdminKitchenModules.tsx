...
import { Box, Link2, LoaderCircle, Power, RefreshCw } from "lucide-react";
    ...
    <section className="space-y-4 rounded-2xl border border-black/10 bg-white p-5">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-black/55">
            3D загварууд хэсэгт “Гал тогооны шүүгээ” ангиллаар оруулсан, бэлэн
            GLB-г хэмжээнд нь холбоно.
          </p>
        </div>
        ...
        <label className="label">
          ...
          >
            ...
            {models.map((model) => (
              ...
              >
                {model.name} · {model.widthMm}×{model.heightMm}×{model.depthMm}{" "}
      ...
      {!models.length && (
        <p className="rounded-xl border border-dashed border-black/15 p-5 text-sm text-black/55">
          Kitchen GLB байхгүй. Admin → 3D загварууд хэсгээс category-г “Гал
          тогооны шүүгээ” сонгон оруулна.
        </p>
      )}
                  ...
                  >
                    <div className="min-w-0">
                      ...
                      <p className="text-black/50">
                        {openingLabel[variant.opening]} · {variant.variantCode}
