...
export default async function HomePage() {
  ...
  return (
    <div className="store-home">
      <section
        className="shop-container home-hero"
      ...
      >
        <div className="hero-copy">
          ...
          <Link href="/planner" className="hero-secondary">
            Эхлээд өрөөндөө байрлуулж үзэх <ArrowUpRight size={15} />
          </Link>
        </div>
        <div className="hero-image">
          <Image
            src="https://images.unsplash.com/photo-1615529182904-14819c35db37?auto=format&fit=crop&w=1400&q=80"
            alt="Байгалийн өнгө, тухтай буйдан, модон тавилгатай зочны өрөө"
            fill
            priority
          ...
          <Link href="/catalog/sofa" className="hero-image-card">
            <div>
              <span>ЗОЧНЫ ӨРӨӨ</span>
              <strong>Тухтай мөчүүд эндээс.</strong>
            </div>
      ...
      <div className="shop-container benefit-strip">
        {[
          {
            icon: Box,
            title: "Тал бүрээс нь хараарай",
            text: "Тавилгаа 3D орчинд үзэх",
          },
          {
            icon: Ruler,
            title: "Өрөөндөө тааруулаарай",
            text: "Хэмжээ, байрлалаа төлөвлөх",
          },
          {
            icon: Heart,
            title: "Өөрийнхөөрөө сонгоорой",
            text: "Өнгө, материалын сонголт",
          },
      ...
      >
        <div className="section-title">
          <div>
            <span className="eyebrow">Хэрэгтэй бүхнээ нэг дороос</span>
            <h2 id="category-title">Юу хайж байна вэ?</h2>
          </div>
          <Link href="/catalog" className="text-link">
            Бүх ангилал <ArrowRight size={17} />
          </Link>
        </div>
      ...
      >
        <div className="section-title">
          <div>
            <span className="eyebrow">Таны дараагийн дуртай тавилга</span>
            <h2 id="featured-title">Онцлох сонголтууд</h2>
          </div>
          <Link href="/catalog" className="text-link">
            Бүгдийг үзэх <ArrowRight size={17} />
          </Link>
        </div>
        {featured.length ? (
          ...
          <div className="shop-empty">
            ...
            <p>Ангилал болон дэлгүүрүүдтэй танилцаарай.</p>
      ...
      >
        <div className="planner-banner">
          <div className="planner-banner-image">
            <Image
              src="https://images.unsplash.com/photo-1631679706909-1844bbd07221?auto=format&fit=crop&w=900&q=80"
              alt="Буйдан, сандлыг зохицуулан байрлуулсан зочны өрөө"
              fill
              sizes="(max-width: 767px) 100vw, 50vw"
              className="object-cover"
            />
            <span className="planner-tag">
              <Box size={16} /> 3D өрөөний төлөвлөгч
            </span>
          </div>
          <div className="planner-banner-copy">
            <span className="eyebrow">Худалдан авахаасаа өмнө</span>
            <h2 id="planner-title">
              Танай өрөөнд
              <br />
              хэрхэн харагдах бол?
            ...
            <p>
              Өрөөнийхөө хэмжээг оруулаад, тавилгаа байрлуулж үзээрэй. Өнгө,
              хэмжээ, зохицол — бүгдийг нэг дор.
            </p>
            <Link href="/planner" className="btn-primary">
              Өрөөгөө төлөвлөх <ArrowUpRight size={17} />
            </Link>
          </div>
        </div>
      </section>
      {newArrivals.length > 0 && (
        ...
        >
          <div className="section-title">
            <div>
              <span className="eyebrow">Шинэ санаа, шинэ мэдрэмж</span>
              <h2 id="new-title">Шинээр нэмэгдсэн</h2>
            </div>
            <Link href="/catalog?sort=new" className="text-link">
              Бүгдийг үзэх <ArrowRight size={17} />
            </Link>
          </div>
          <div className="product-grid">
      ...
      >
        <div className="section-title">
          <div>
            <span className="eyebrow">Ойроос харж, мэдэрч сонгох</span>
            <h2 id="stores-title">Дэлгүүрүүдтэй танилцах</h2>
          </div>
          <Link href="/stores" className="text-link">
            Байршил үзэх <ArrowRight size={17} />
          </Link>
        </div>
        <div className="store-grid">
          {STORES.slice(0, 4).map((s) => (
            ...
            >
              <span className="store-monogram">{s.name.slice(0, 1)}</span>
              <div>
                <h3>{s.name}</h3>
                <span>
                  <MapPin size={13} />
