...
Wall editing verified on 2026-09-16: the full suite passed 181 tests, including 26 wall-editing regressions. Production build, type checking and lint passed. Browser checks covered new-design/new-room entry, actual wall dragging at desktop and 390 px mobile widths, exact keyboard steps, short feature-handle selection, live area/inputs and one-step undo/redo. A focused SVG group rendering artifact was resolved by putting keyboard focus on the handle circles; handles render above neighboring wall touch targets.
